...
export default function SERVICESCreateForm(props) {
  ...
  const resetStateValues = () => {
    setAwesome(initialValues.awesome);
    setServices(initialValues.services);
    setText(initialValues.text);
    setCardDesign(initialValues.cardDesign);
    setCardDeveloper(initialValues.cardDeveloper);
    setCardUi(initialValues.cardUi);
    setErrors({});
  };
  const validations = {
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          await DataStore.save(new SERVICES(modelFields));
          if (onSuccess) {
