...
export default function PORTFOLIOCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setRecent(initialValues.recent);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          await DataStore.save(new PORTFOLIO(modelFields));
          if (onSuccess) {
      ...
      {...rest}
      {...getOverrideProps(overrides, "PORTFOLIOCreateForm")}
    >
      <TextField
        label="Recent"
        isRequired={true}
