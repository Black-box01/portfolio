...
export default function PORTFOLIOLAPTOPNEWCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setImgLaptop(initialValues.imgLaptop);
    ...
    setBtnTex(initialValues.btnTex);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          await DataStore.save(new PORTFOLIOLAPTOPNEW(modelFields));
          if (onSuccess) {
      ...
      {...rest}
      {...getOverrideProps(overrides, "PORTFOLIOLAPTOPNEWCreateForm")}
    >
      <TextField
        label="Img laptop"
        isRequired={false}
